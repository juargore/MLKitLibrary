...
class BitmapUtils {
    ...
    fun getBitmap(data: ByteBuffer, metadata: FrameInformation): Bitmap? {
        data.rewind()
    ...
    fun getBitmap(image: ImageProxy): Bitmap? {
        val frameInformation = FrameInformation.Builder()
        ...
        return getBitmap(nv21Buffer, frameInformation)
    }
